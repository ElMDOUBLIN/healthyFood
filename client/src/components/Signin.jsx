...
export default class Signin extends Component {
  constructor(props){
    ...
    check(){
       ...
       }else {alert('error admin inexistant')
  ...
  handlechange(event) {
    ...
    <button type="submit" onClick={()=>this.check()}>Login</button>
   

 
    <button type="button" className="cancelbtn" onClick={()=>this.props.changeView("itemlist")}>Cancel</button>
